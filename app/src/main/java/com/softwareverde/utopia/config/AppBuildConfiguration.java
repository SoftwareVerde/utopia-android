...
import com.softwareverde.utopia.AndroidIntelSyncFactory;
...
public class AppBuildConfiguration implements BuildConfiguration {
    ...
    private void _setSessionDependencies(final Context applicationContext) {
        ...
        sessionDependencies.setIntelSyncFactory(new AndroidIntelSyncFactory(applicationContext));
